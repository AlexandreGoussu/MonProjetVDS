        ...
        <div class="row mx-1">
            <div class="col-sm-6">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input id="email" type="text" class="form-control-plaintext" readonly
                               value="<?= $ligne['nom']; ?>">
                    </div>
                </div>
                ...
                <div class="form-group row mt-3">
                    <label for="telephone" class="col-sm-4 col-form-label">Téléphone <i id="effacerTelephone"
                                                                                        class='bi bi-eraser text-danger'
            ...
            <div class="col-sm-6">
                ...
                Votre photo dans l'annuaire <i id="effacer" class='bi bi-eraser text-danger fs-2'
                                               style="cursor : pointer; display:none"></i>
                ...
                <div>
                    La photo sera automatiqument redimensionner en 200 * 200. Si le résultat n'est pas conforme à vos
                    attentes, utilisez le lien suivant pour redimensionner préalablement votre photo :
