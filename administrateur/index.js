...
let $nomtitre  // champ associé à l'autocomplétion
    ...
    let option = {
        ...
        list: {
            ...
            onChooseEvent: function () {
                ...
                id = $nomtitre.getSelectedItemData().id;
                messageNomtitre.innerText = "";

            },
            onLoadEvent: function () {
                // correction fichier incident 1
                id = null;
                let lesValeurs = $nomtitre.getItems();
                if (lesValeurs.length === 0) {
                    messageNomtitre.innerText = "Aucun nom ne correspond";

                }
            }
        }
    }
    $nomtitre.easyAutocomplete(option);
}
...
function ajouterAdministrateur() {
    ...
    messageNomtitre.innerText = "";
    if (id == null) {
        messageNomtitre.innerText = "Il faux sélectionner un membre dans la liste à partir de la saisie de son nom"
    } else {
        // demande d'ajout
        $.ajax({
            ...
            success: function () {
                ...
                idMembre.add(new Option(nomtitre.value, id));
                // sélectionner cet élément c'est le dernier
                ...
                let parametre = {
                    message: "<div class='m-3' style='text-align: justify'>" + nomtitre.value + " fait maintenant parti des administrateurs. <br> il vous reste à sélectionner les modules qu'il peut gérer" + "</div>",
                    type: 'success',
                    fermeture: 1,
